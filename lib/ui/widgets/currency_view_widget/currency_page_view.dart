...
import 'package:buku_pesak/core/services/currency/currency_input_formater.dart';
...
class CurrencyPageView extends CurrencyPageState {
  @override
        ...
        child: FutureBuilder<dynamic>(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              return CurrencyList(exchange, value);
