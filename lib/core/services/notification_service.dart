...
class NotificationService {
  ...
  getPlatformChannelSpecfics() {
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
        ...
        ticker: 'Pengingat Harian Buku Pesak',
        playSound: true,
        sound: RawResourceAndroidNotificationSound('buku_pesak_pengingat'),
        largeIcon: DrawableResourceAndroidBitmap('icon_buku_pesak'));
